...
@mcp.tool()
async def simple_beams_frquency(beamtype: str,rhoA: float,EI: 
...
async def beams_frquency(rhoA: float,EI: float,length: float, 
                         linearsprings: tuple[float,float],
                         torsionalsprings: tuple[float,float]) -> float:
    """Calcuate the natural angular frequency of a beam,
